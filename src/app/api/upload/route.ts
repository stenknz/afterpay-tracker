...
export async function POST(req: Request) {
  ...
  const subdir = type === "avatar" ? "avatars" : type === "vendor" ? "vendors" : type === "site" ? "site" : type === "subscription" ? "subscriptions" : type === "utility" ? "utilities" : "stores";
  const prefix = subdir === "avatars" ? "avatar" : subdir === "vendors" ? "vendor" : subdir === "site" ? "site" : subdir === "subscriptions" ? "subscription" : subdir === "utilities" ? "utility" : "store";
