        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-bold">{plan.title || plan.store?.name || "Untitled Plan"}</h2>
          ...
          {isOwner && (
            <div className="flex gap-2">
              <Link
                ...
                className="p-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:bg-primary-50 hover:text-primary-600 transition-colors"
              >
